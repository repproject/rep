...
class NvCmpxAtcl(Base,KTable):
    ...
    nvcmpxtyp = relationship('NvCmpxTyp',primaryjoin = and_(job_id==NvCmpxTyp.job_id , exec_dtm==NvCmpxTyp.exec_dtm , nv_cmpx_id==NvCmpxTyp.nv_cmpx_id , nv_cmpx_typ_seq==NvCmpxTyp.nv_cmpx_typ_seq), foreign_keys = [NvCmpxTyp.job_id , NvCmpxTyp.exec_dtm , NvCmpxTyp.nv_cmpx_id , NvCmpxTyp.nv_cmpx_typ_seq], passive_deletes = True)
