    ...
    def search(self):
        try:
            if self.preSearch():
                ...
                Columns2 = ['PASI_ID', 'SEQ', 'ITEM_NM', 'ITEM_VAL', 'ITEM_SRC_CL_CD', 'TBL_NM', 'COL_NM', 'EXCP_STR' , 'ITEM_DESC', 'DEL_YN']
                Widths2 = {'PASI_ID':100,'SEQ':40, 'ITEM_NM':120, 'ITEM_VAL':100, 'ITEM_SRC_CL_CD':70, 'TBL_NM':150, 'COL_NM':150, 'EXCP_STR':70, 'ITEM_DESC':200, 'DEL_YN':50}
